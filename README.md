...
WinSyn is a dataset of photographs of building windows from around the world. It is described in the publication [A High Resolution Testbed for Synthetic Data](https://twak.github.io/winsyn/) by Tom Kelly (Kaust), John Femiani (MiamiOh), and Peter Wonka (Kaust). See also the [procedural model](https://github.com/twak/winsyn) and a [short video introduction](https://youtu.be/Ri-1iq4PBuc).
